                ...
                return NotificationListener<ScrollNotification>(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Obx(() {
                        final bool isBookmarked = bookmarkController.isBookmarked(clip);
                        return ClipCard(
                          clip: clip,
                          ...
                          onTap: () {
                            Get.to(
                              ...
                              controller.fetchSingleClip(clip.clipId).then((updated) {
                                if (updated != null) {
                                  final idx = controller.clipsList.indexWhere(
