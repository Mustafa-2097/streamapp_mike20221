    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: const BoxDecoration(
          color: Colors.transparent, // Ensures the entire area captures taps
        ),
        child: Row(
          children: [
            ...
            // Join Button (Shown only if NOT already joined)
            if (!room.isJoined)
              ElevatedButton(
                onPressed: () async {
                  final RoomsController controller = Get.find<RoomsController>();
                  ...
                  if (success) {
                    ...
                    // Refresh data to update isJoined status
