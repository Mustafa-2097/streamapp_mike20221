...
class NewsScreen extends StatelessWidget {
  ...
  Widget _buildSwipeableItem(Article item, int index) {
    return Dismissible(
  ...
  Widget _buildNewsCard(Article item) {
    return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(
                      item.publishedAt != null && item.publishedAt!.length >= 10
